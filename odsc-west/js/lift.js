function lift() {
  ...
  function showMedians() {
    actPoints.transition().duration(400).attr('opacity', 0.2);
    actLine.transition().duration(400).attr('opacity', 0.2);
    predPoints.transition().duration(400).attr('opacity', 0.2);
    predLine.transition().duration(400).attr('opacity', 0.2);

    // showPoints(predMedianPoints, predMedianPointsSvg, pred_median, 'pred-median-point');
    showPoints(actMedianPoints, actMedianPointsSvg, act_median, 'act-median-point');
    actMedianLine.attr('d', line(act_median)).attr('opacity', 0);
    animateLine(actMedianLine, 400);
  }

  function show25() {
    showPoints(actTop25Points, actTop25PointsSvg, act_top25, 'act-point-top25');
    showPoints(actBottom25Points, actBottom25PointsSvg, act_bottom25, 'act-point-bottom25');
    ...
    animateLine(actBottom25Line, 400, () => {
      // Fill in
      top25FillLine.attr('d', lineForFill(top25_fill)).attr('opacity', 1);
      bottom25FillLine.attr('d', lineForFill(bottom25_fill)).attr('opacity', 1);
    });
  }

  function show10() {
    // TODO will have to expand axis to view the top 10%
    showPoints(actTop10Points, actTop10PointsSvg, act_top10, 'act-point-top10');
    showPoints(actBottom10Points, actBottom10PointsSvg, act_bottom10, 'act-point-bottom10');
    ...
    animateLine(actBottom10Line, 400, () => {
      top10FillLine.attr('d', lineForFill(top10_fill)).attr('opacity', 1);
      bottom10FillLine.attr('d', lineForFill(bottom10_fill)).attr('opacity', 1);
    });
  }
